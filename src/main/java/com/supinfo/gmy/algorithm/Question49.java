...
public class Question49 {
	...
	public int getMost(int[][] board) {
		...
		/*
		 * 初始数组的情况。 564 448 654 186 490 699 487 444 563 228 365 261 429 505 612 564 715
		 * 726 464 617 234 647 702 263 245 249 231 462 453 646 669 510 492 512 622 135
		 */
		/*
		 * 结束后返回的数组。 564 1012 1666 1852 2342 3041 1051 1495 2229 2457 2822 3302 1480
		 * 2000 2841 3405 4120 4846 1944 2617 3075 4052 4822 5109 2189 2866 3306 4514
		 * 5275 5921 2858 3376 3868 5026 5897 6056 可以看到，最后一个坐标点的值6056，他就是当前最优的路径所得出来的值
		 */
